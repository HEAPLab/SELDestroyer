 ...
 */
bool i2c_send_b(uint8_t address, const uint8_t* data, uint16_t nr_bytes);

/**
 * Send a sequence of identical bytes on the I2C bus in BLOCKING mode
 */
bool i2c_send_zeros_b(uint8_t address, uint8_t command, uint8_t byte, uint16_t nr_bytes);
 ...
 */
bool i2c_recv_b(uint8_t address, uint8_t* data, uint16_t nr_bytes);

/**
 * Send/Receive a sequence of bytes on the I2C bus in BLOCKING mode
 */
uint8_t i2c_sendrecv_b(uint8_t address, const uint8_t* send_data, uint16_t send_nr_bytes, uint8_t* recv_data, uint16_t recv_nr_bytes);
